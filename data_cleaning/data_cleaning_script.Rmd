...
london2024 = read.csv("../data/raw/london_housing_2024.csv")
```
...
london2024 = london2024 |>
  # Omit NA values
  drop_na() |>
  # Convert 2024 Pounds to 2024 USD (1 pound = $1.27)
  mutate(Price = Price * 1.27) |>
  # Remove Index Column
  select(-X) |>
